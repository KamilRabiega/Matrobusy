<%@ Page Title="Trasy z ostatnich dwóch tygodni" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Wykres5.aspx.cs" Inherits="Projekt_autobus.Wykres5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <!-- SQL dla bazy -->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Matrobusy %>" SelectCommand="SELECT [Dzien], COUNT(Dzien) AS [Ilość tras] FROM [Trasy] WHERE [Dzien] BETWEEN @Dwatygtemu AND @Dzisiaj GROUP BY Dzien">
        <SelectParameters>
