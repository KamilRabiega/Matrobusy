<%@ Page Title="Trasy szczegółowe - dzisiaj" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="kierodzisiaj.aspx.cs" Inherits="Projekt_autobus.kierodzisiaj" %>
...
WHERE (([Login] = @Login) AND ([Dzien] = @Dzien))">
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col">
                <h2>Twoje dzisiejsze trasy szczegółowo</h2>
            </div>
        </div>
        <div class="row text-center">
            <div class="col">
                <asp:GridView style="font-size: 12px;" ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" AllowPaging="True">
